  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="ADSA Australian Solar — CEC accredited solar installers across Melbourne and Victoria. Solar panels, battery storage, EV chargers and electrical services. Government rebates up to $2,800. Free quote." 
        />
        ...
        <meta property="og:description" content="Melbourne's trusted solar installers. Government rebates up to $2,800. Free quotes & fast installation." />
          ...
          {JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Victorians can access STC rebates (up to $2,800 for solar) and Cheaper Home Batteries Program rebates (~$300-$370 per kWh, up to $5,000 for a 13.5kWh battery)."
                }
              },
              {
                "@type": "Question",
